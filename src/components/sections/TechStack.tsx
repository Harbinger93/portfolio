              ...
              <div className="h-full flex flex-col p-6 glass rounded-2xl hover:border-[var(--accent-primary)] transition-colors duration-300">
                ...
                <div className="flex flex-wrap gap-2">
                  {category.tags.map((tag) => (
                    <div 
                      key={tag} 
                      className="px-3 py-1.5 rounded-lg bg-[var(--bg-secondary)] border border-[var(--glass-border)] text-xs font-medium text-[var(--text-primary)] flex items-center gap-1.5 hover:border-[var(--accent-primary)]/50 transition-colors cursor-default"
                    >
